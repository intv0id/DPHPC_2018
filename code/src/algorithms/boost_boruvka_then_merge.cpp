...
l_edge_t boost_boruvka_then_merge::algorithm(Graph &g, unsigned int n_threads) {
    ...
    boruvka_then_merge(make_vertex_list_adaptor(g.boost_distrib_rep), w, back_inserter(v),  get(boost::vertex_index, g.boost_distrib_rep));
