...
l_edge_t boost_merge_local::algorithm(Graph &g, unsigned int n_threads) {
    ...
    merge_local_minimum_spanning_trees(make_vertex_list_adaptor(g.boost_distrib_rep), w, back_inserter(v),  get(boost::vertex_index, g.boost_distrib_rep));
