...
\usepackage{graphics}
\graphicspath{../interpret/figures/final2/}
...
\begin{figure}\centering
  \includegraphics[width=\linewidth]{../interpret/figures/final2/Graph_runtime_Preferential attachment 100 edges per vertice_1000.eps}
  \caption{Runtime graph on PA(1 000, 100)\label{baseline1}}
\end{figure}

\begin{figure}\noindent\centering
  \includegraphics[width=\linewidth]{Graph_runtime_Preferential attachment 20 edges per vertice_2000.eps}
...
\begin{figure}\noindent\centering
  \includegraphics[width=\linewidth]{Box_Speedup_Erdos-Renyi random p=0.200000_10000.eps}
  \caption{Runtime graph on ER(10 000, 2 000)\label{denseERruntime}}
\end{figure}

\begin{figure}\noindent\centering
  \includegraphics[width=\linewidth]{BoostKruskalSpeedup4.png} % CHANGE NAME
...
% PA = Beaucoup moins régulier que ER :nodes with much more edges
% Donc des résultats moins propres quand on sépare "équitablement" par noeud (each processor treats the same amount of nodes : not fair / less parallelism)
